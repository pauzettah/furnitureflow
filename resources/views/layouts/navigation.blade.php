                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(Auth::user()->role === 'carpenter')
                            <x-nav-link :href="route('carpenter.dashboard')" :active="request()->routeIs('carpenter.dashboard')">
                                {{ __('Dashboard') }}
                            </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @elseif(Auth::user()->role === 'carpenter')
                    <x-responsive-nav-link :href="route('carpenter.dashboard')" :active="request()->routeIs('carpenter.dashboard')">
                        {{ __('Dashboard') }}
                    </x-responsive-nav-link>
                @elseif(Auth::user()->role === 'delivery')
