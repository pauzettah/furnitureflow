        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card p-6 fade-up fade-up-1">
                ...
                <div class="flex gap-4 mb-5">
                    <div
                        class="w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-400 text-2xl flex-shrink-0">
                ...
                @if($order['balance'] > 0)
                    ...
                    <form action="{{ route('customer.payment') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="amount" class="form-input" value="{{ $order['balance'] }}" min="1"
                                max="{{ $order['balance'] }}">
                        </div>
                        <div class="mb-3">
            ...
            <div class="card p-6 fade-up fade-up-2" id="delivery">
                ...
                @else
                    <div class="text-center py-6 text-gray-400">
                        ...
                        <p class="text-sm">Delivery scheduling is available once your order is <span
                                class="font-medium text-blue-500">Ready</span>.</p>
                    </div>
                @endif
            </div>
