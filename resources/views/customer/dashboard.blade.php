            ...
            <aside class="hidden lg:flex flex-col w-56 flex-shrink-0">
                <div class="card p-3 sticky top-24">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="#payments" class="nav-link flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600">
                            <i class="fa-solid fa-credit-card w-4 text-center text-blue-500"></i> Payments
                        </a>
                        <a href="#delivery" class="nav-link flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600">
